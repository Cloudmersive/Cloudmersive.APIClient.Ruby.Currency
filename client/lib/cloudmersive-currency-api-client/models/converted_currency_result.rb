...
module CloudmersiveCurrencyApiClient
  ...
  class ConvertedCurrencyResult
    # The converted price in the destination currency
    attr_accessor :converted_price
    ...
    attr_accessor :formatted_price_as_string
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ConvertedPrice')
        self.converted_price = attributes[:'ConvertedPrice']
      end
      ...
      if attributes.has_key?(:'FormattedPriceAsString')
        self.formatted_price_as_string = attributes[:'FormattedPriceAsString']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          formatted_price_as_string == o.formatted_price_as_string
    end
    ...
    def hash
      [converted_price, iso_currency_code, currency_symbol, formatted_price_as_string].hash
    end
